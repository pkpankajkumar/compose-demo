...
public class TransactionService {
    ...
    public List<TransactionResponseDto> readIncome(String type,Integer userId,String familyId, String userRole){
        List<TransactionModel> transactionList;
        if(userRole.equals("ROLE_USER")){
            transactionList = transactionRepository.findByTransactionTypeAndUserId(type,userId);
        } else if (userRole.equals("ROLE_ADMIN")) {
            transactionList = transactionRepository.findByTransactionTypeAndUserIdAndFamilyId(type,userId,familyId);
        }
        else {
            transactionList = transactionRepository.findByTransactionType(type);
        }
