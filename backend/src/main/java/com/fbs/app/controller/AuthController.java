...
import com.fbs.app.dto.GoogleRequestDto;
...
public class AuthController {
    ...
    public ResponseEntity<?> register(@RequestBody UserRequestDto user) {
        ...
        userModel.setFamilyId(familyId);
    ...
    public ResponseEntity<?> login(@RequestBody UserRequestDto user) {
        ...
        String accessToken = jwtUtil.generateAccessToken(existing.getEmail() , roleNames , existing.getId(),existing.getFamilyId());
    ...
    public ResponseEntity<?> refresh(HttpServletRequest request) {
        ...
        String newAccessToken = jwtUtil.generateAccessToken(existing.getEmail(), roleNames, existing.getId(),existing.getFamilyId());
